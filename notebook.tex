...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
        ...
        \PY{n}{HOUSING\PYZus{}PATH} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{datasets/housing}\PY{l+s+s2}{\PYZdq{}}
        \PY{k}{def} \PY{n+nf}{load\PYZus{}housing\PYZus{}data}\PY{p}{(}\PY{n}{housing\PYZus{}path}\PY{o}{=}\PY{n}{HOUSING\PYZus{}PATH}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{housing} \PY{o}{=} \PY{n}{load\PYZus{}housing\PYZus{}data}\PY{p}{(}\PY{p}{)}
        \PY{n}{housing}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:}    longitude  latitude  housing\_median\_age  total\_rooms  total\_bedrooms  \textbackslash{}
